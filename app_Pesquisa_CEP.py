...
st.set_page_config(page_title="Tecnolab Log V7.6", layout="wide")

# --- CSS PARA MÁXIMO APROVEITAMENTO VERTICAL ---
st.markdown("""
    <style>
    .block-container {
        padding-top: 1rem; 
...
# --- CONTEÚDO ---
st.markdown('<h2 class="titulo-compacto">📍 Painel Logístico Tecnolab</h2>', unsafe_allow_html=True)
    ...
    if "erro" not in r:
        ...
        try:
            ...
            with col_left:
                ...
                # --- MÉTRICAS LADO A LADO (GANHO DE ESPAÇO) ---
                m1, m2 = st.columns(2)
                ...
                # Quadro de unidades com todas as linhas
            ...
            with col_right:
                ...
                st_folium(m, use_container_width=True, height=600, key="mapa_v76")
